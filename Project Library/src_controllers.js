...
function displayWindowPreview() {
    // Set the name content to include "name"
    let descripContentHtml = `<strong style="font-family: Futura Bk BT;">Name:</strong> ${descripWindow.attr("window-name") ? `<span style="font-family: Futura Bk BT;">${descripWindow.attr("window-name")}</span>` : ""}`;
